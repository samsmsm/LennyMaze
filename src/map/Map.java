...
public class Map extends Group {
	...
	/**
	 * Adds a new Block at the end of a specified row
	 * 
	 * @param b
	 *            a Block
	 * @param row
	...
	/**
	 * Returns a Block at a specified place in the maze.<br>
	 * Returns <code>null</code> if there is an invalid index.
	 * 
	 * @param x
	 *            index-x
	 * @param y
	 *            index-y
	 * @return The Block at specified place
	 */
